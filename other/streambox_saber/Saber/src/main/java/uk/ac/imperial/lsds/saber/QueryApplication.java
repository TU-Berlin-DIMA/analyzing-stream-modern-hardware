...
public class QueryApplication {
    ...
    // private String hwPerfCounters;
    private PAPIHardwareSampler[] papi_samplers;
	// public QueryApplication (Set<Query> queries) {
    //     System.out.println("[DBG]: Setup QueryApplication with PAPI SAMPLERS");
	// 	this.queries = queries;
	...
	public QueryApplication (Set<Query> queries, PAPIHardwareSampler[] papi_samplers) {
        System.out.println("[DBG]: Setup QueryApplication with PAPI SAMPLERS");
		this.queries = queries;
		...
		N = this.queries.size();
        this.papi_samplers = papi_samplers;
	}
	...
	public void setup() {
        ...
        if (this.papi_samplers != null) {
            workerPool = new TaskProcessorPool(threads, queue, policy, SystemConf.GPU, SystemConf.HYBRID, this.papi_samplers);
        } else {
            // System.out.println("no papi");
