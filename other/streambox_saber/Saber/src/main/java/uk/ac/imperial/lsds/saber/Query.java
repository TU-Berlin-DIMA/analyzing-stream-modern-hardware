...
public class Query {
    ...
    public PAPIHardwareSampler[] query_papi_samplers;
	...
	public Query(
		...
		this(id, operators, firstSchema, firstWindow, secondSchema, secondWindow, queryConf, timestampReference);
        this.query_papi_samplers = papi_samplers;
	}
	public Query (
			int id,
			Set<QueryOperator> operators,
