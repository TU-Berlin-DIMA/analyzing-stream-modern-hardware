...
public class TaskDispatcher implements ITaskDispatcher {
	...
	public TaskDispatcher (Query query) {
        ...
        buffer = new CircularQueryBuffer(parent.getId(), SystemConf.CIRCULAR_BUFFER_SIZE, false, query.query_papi_samplers);
	...
	public void dispatch (byte [] data, int length) {
        ...
        // int tupleSize = 256;
        // System.out.println("[DBG] TaskDispatcher: ");
        // for (int i = 0; i < 2; i ++) {
        //     System.out.print("[DBG] pickup_ts: " + buffer.getLong(i * tupleSize + 72));
        //     System.out.print(", dropoff_ts: " + buffer.getLong(i * tupleSize + 80));
        //     System.out.print(", passenger_count: " + buffer.getLong(i * tupleSize + 88));
        //     System.out.print(", pickup_long: " + buffer.getDouble(i * tupleSize + 128));
        //     System.out.print(", pickup_lang: " + buffer.getDouble(i * tupleSize + 136));
        //     System.out.println();
        // }
