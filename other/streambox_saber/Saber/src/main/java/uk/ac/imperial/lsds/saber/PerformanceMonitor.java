		...
		public String info (long delta) {
            ...
            if (_bytesProcessed > 0) {
				...
				if (this.id == 0) {
                    ...
                    thoughputAvg = ((throughputSum / throughputCounter) * _1MB_) / 256 / 1000; // tuple size to get the records per second
					numberAsString = numberFormat.format((double) thoughputAvg);
					System.out.println("Throughput Average(Krecords/sec) " + numberAsString);
				}
