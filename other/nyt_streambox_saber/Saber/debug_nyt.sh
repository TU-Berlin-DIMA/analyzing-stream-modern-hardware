...
PAPI="${MVN}/papi/papi-java-api/1.0-SNAPSHOT/papi-java-api-1.0-SNAPSHOT.jar"
...
OPTS="-server -XX:+UseConcMarkSweepGC -XX:NewRatio=2 -XX:SurvivorRatio=16 -Xms8g -Xmx16g"
...
CLASS=uk.ac.imperial.lsds.saber.experiments.benchmarks.nyt.NYTBenchmarkApp
...
jdb -sourcepath src/main/java:src/test/java -classpath $JCP $CLASS
