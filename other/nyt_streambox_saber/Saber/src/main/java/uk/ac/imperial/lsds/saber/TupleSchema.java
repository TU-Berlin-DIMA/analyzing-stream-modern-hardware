...
public class TupleSchema implements ITupleSchema {
	...
	public enum PrimitiveType {
		UNDEFINED, INT, FLOAT, LONG, LONGLONG, BYTE, VARCHAR, DOUBLE;
	}
	...
	public String getSchema () {
		...
		for (int i = 0; i < numberOfAttributes(); ++i) {
            ...
            case     BYTE: s.append("byte"); break;
            case  VARCHAR: s.append("varchar"); break;
            case   DOUBLE: s.append("double"); break;
			default:
