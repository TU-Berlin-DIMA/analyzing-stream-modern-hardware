...
import uk.ac.imperial.lsds.saber.cql.expressions.doubles.DoubleExpression;

public class DoubleComparisonPredicate implements IPredicate {
	...
	public DoubleComparisonPredicate (DoubleExpression v1, DoubleExpression v2) {
		this(EQUAL_OP, v1, v2);
	}

	public DoubleComparisonPredicate (int op, DoubleExpression v1, DoubleExpression v2) {
		this.op = op;
		this.v1 = v1;
		this.v2 = v2;
	}
	...
	public boolean satisfied (IQueryBuffer buffer, ITupleSchema schema, int offset) {
        // System.out.println("[DBG] double comparsion predicate's satisfied is called.");
		double val1 = v1.eval(buffer, schema, offset);
		double val2 = v2.eval(buffer, schema, offset);
	...
	public boolean satisfied (
		...
		double val1 = v1.eval(buffer1, schema1, offset1);
		double val2 = v2.eval(buffer2, schema2, offset2);
