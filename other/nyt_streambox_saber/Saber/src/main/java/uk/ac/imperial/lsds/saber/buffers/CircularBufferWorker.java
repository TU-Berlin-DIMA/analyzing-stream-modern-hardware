...
public class CircularBufferWorker implements Runnable {
	...
	public CircularBufferWorker (CircularQueryBuffer circularBuffer, int id) {
        System.out.println("[DBG] Init CircularBufferWorker");
		this.circularBuffer = circularBuffer;
		this.id = id;
        this.hwPAPI = null;
	}

	public CircularBufferWorker (CircularQueryBuffer circularBuffer, int id, PAPIHardwareSampler papi_sampler) {
        System.out.println("[DBG] Init CircularBufferWorker with PAPI");
		this.circularBuffer = circularBuffer;
		this.id = id;
