...
public class YahooBenchmark extends InputStream {
	...
	public YahooBenchmark (QueryConf queryConf, boolean isExecuted, ByteBuffer campaigns, boolean isV2, PAPIHardwareSampler[] operators_papi_samplers, PAPIHardwareSampler[] query_papi_samplers) {
	...
	public void createApplication(QueryConf queryConf, boolean isExecuted, ByteBuffer campaigns) {
		...
		// Query query1 = new Query (0, operators, inputSchema, windowDefinition, null, null, queryConf, timestampReference, this.query_papi_samplers);
