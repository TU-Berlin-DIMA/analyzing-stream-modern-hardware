...
public class GeneratorWorker implements Runnable {
	...
	private PAPIHardwareSampler papi_sampler;
	...
	public GeneratorWorker (Generator generator, int startPos, int endPos, int id, boolean isV2, PAPIHardwareSampler papi_sampler) {
		this(generator, startPos, endPos, id, isV2);
        this.papi_sampler = papi_sampler;
	}
	...
	public void run() {
		...
		started = true;
        // try {
            // this.papi_sampler.startSampling();
